...
class InsertKentuckyLocalTaxesWithoutCap extends Migration
{
    ...
    private const CLASSES = [
        ...
        'Brooskville City' => Appleton\Taxes\Countries\US\Kentucky\BrooskvilleCity\BrooskvilleCity::class,
        ...
        'Cumberland School County' => Appleton\Taxes\Countries\US\Kentucky\CumberlandSchoolCity\CumberlandSchoolCity::class,
        'Fort Wright City' => Appleton\Taxes\Countries\US\Kentucky\FortWrightCity\FortWrightCity::class,
        'Highland Heights City' => Appleton\Taxes\Countries\US\Kentucky\HighlandsHeightsCity\HighlandsHeightsCity::class,
