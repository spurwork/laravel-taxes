...
abstract class NewJerseyIncome extends BaseStateIncome
{
    ...
    const SURVIVING_SPOUTSE_SURVIVING_CIVIL_UNION_PARTNET = 'E';
    ...
    const FILING_STATUSES = [
        ...
        self::SURVIVING_SPOUTSE_SURVIVING_CIVIL_UNION_PARTNET => 'SURVIVING_SPOUTSE_SURVIVING_CIVIL_UNION_PARTNET',
    ];
