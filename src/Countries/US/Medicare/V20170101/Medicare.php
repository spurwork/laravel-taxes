...
class Medicare extends BaseMedicare
{
    ...
    {
        return max($this->payroll->getEarnings() - max(static::ADDITIONAL_TAX_AMOUNT[$this->tax_information->filing_status] - $this->payroll->getYtdEarnings(), 0), 0) * static::ADDITIONAL_TAX_RATE;
    }
