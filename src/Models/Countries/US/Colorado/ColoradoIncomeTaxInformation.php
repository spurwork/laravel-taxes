...
{
    protected $config_name = 'taxes.tables.us.colorado.colorado_income_tax_information';
    ...
    public static function getDefault()
    {
        ...
        $tax_information->filing_status = ColoradoIncome::FILING_SINGLE;
