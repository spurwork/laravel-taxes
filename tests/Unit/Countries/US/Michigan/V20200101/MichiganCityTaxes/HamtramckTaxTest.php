...
use Appleton\Taxes\Countries\US\Michigan\MichiganCityTaxes\HamtramckTax\HamtramckTax;
...
class HamtramckTaxTest extends TaxTestCase
{
    private const DATE = '2020-01-01';
    private const LOCATION = 'us.michigan';
    private const TAX_CLASS = HamtramckTax::class;
        ...
        return [
            ...
            'resident living in a city that levies a tax and works in another city' => [
                $builder
                    ->setTaxInfoOptions([
                        'resident_city' => 'Hamtramck',
                        'primary_nonresident_city' => 'Hamtramck',
                    ])
                    ->setWagesInCents(30000)
                    ->setExpectedAmountInCents(300)
                    ->build()
