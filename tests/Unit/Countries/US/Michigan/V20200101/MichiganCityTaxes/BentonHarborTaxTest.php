...
use Appleton\Taxes\Countries\US\Michigan\MichiganCityTaxes\BentonHarborTax\BentonHarborTax;
...
class BentonHarborTaxTest extends TaxTestCase
{
    private const DATE = '2020-01-01';
    private const LOCATION = 'us.michigan';
    private const TAX_CLASS = BentonHarborTax::class;
        ...
        return [
            ...
            'resident living in a city that levies a tax and works in another city' => [
                $builder
                    ->setTaxInfoOptions([
                        'resident_city' => 'BentonHarbor',
                        'primary_nonresident_city' => 'BentonHarbor',
                    ])
                    ->setWagesInCents(30000)
                    ->setExpectedAmountInCents(300)
                    ->build()
            ...
            'Lives in a city that levies a tax AND works in 2 other cities that both levy a tax not resident city primary higher percentage' => [
                $builder
                    ->setTaxInfoOptions([
                        'resident_city' => 'Detroit',
                        'primary_nonresident_city' => 'Detroit',
                        'secondary_nonresident_city' => 'BentonHarbor',
