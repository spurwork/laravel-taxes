...
class AlleganyTest extends TaxTestCase
{
    private const DATE = '2019-01-01';
    private const HOME_LOCATION = 'us.maryland.allegany';
    private const WORK_LOCATION = 'us.maryland';
    private const TAX_CLASS = Allegany::class;
