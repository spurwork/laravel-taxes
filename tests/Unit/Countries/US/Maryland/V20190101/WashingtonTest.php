...
class WashingtonTest extends TaxTestCase
{
    private const DATE = '2019-01-01';
    private const HOME_LOCATION = 'us.maryland.washington';
    private const WORK_LOCATION = 'us.maryland';
    private const TAX_CLASS = Washington::class;
