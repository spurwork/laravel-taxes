...
class ColoradoIncomeTest extends TaxTestCase
{
    ...
    {
        ColoradoIncomeTaxInformation::forUser($this->user)->delete();
        ...
        return [
            ...
            'tasie_test1' => [
                $builder
                    ->setTaxInfoOptions([
                        'exempt' => true,
                        'filing_status' => ColoradoIncome::FILING_SEPERATE,
                        'form_version' => '2019',
        ...
        return [
            ...
            'A2' => [
                $builder
                    ->setTaxInfoOptions([
                        'exempt' => false,
                        'filing_status' => ColoradoIncome::FILING_JOINTLY,
                        'form_version' => '2020',
                        'dependents_deduction_amount' => 0,
                        'deductions' => 0,
                        'extra_withholding' => 0,
            ...
            'A3' => [
                $builder
                    ->setTaxInfoOptions([
                        'exempt' => false,
                        'filing_status' => ColoradoIncome::FILING_HEAD_OF_HOUSEHOLD,
                        'form_version' => '2020',
                        'dependents_deduction_amount' => 0,
                        'deductions' => 0,
                        'extra_withholding' => 0,
