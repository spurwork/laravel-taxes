...
class AuroraOccupationalPrivilegeTest extends ColoradoLocalTaxTestCase
{
    public function setUp(): void
    {
        parent::setUp();
        $this->query_runner->addTax(AuroraOccupationalPrivilege::class);
    }
    ...
    public function provideData(): array
    {
        ...
        return $this->standardColoradoLocalTestCases(
            $date,
            'us.colorado.aurora',
            AuroraOccupationalPrivilege::class,
            25000,
            200);
    }
}
