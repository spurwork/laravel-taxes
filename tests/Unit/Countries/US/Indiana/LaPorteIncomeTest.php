...
class LaPorteIncomeTest extends TestCase
{
    ...
    public function testLaPorteIncome(): void
    {
        ...
        $results = $this->taxes->calculate(function (Taxes $taxes) {
            ...
            $taxes->setWorkLocation($this->getLocation('us.indiana.laporte'));
            $taxes->setUser($this->user);
            $taxes->setEarnings(300);
            $taxes->setPayPeriods(52);
        });

        $this->assertThat(2.84, self::identicalTo($results->getTax(LaPorteIncome::class)));
    }
