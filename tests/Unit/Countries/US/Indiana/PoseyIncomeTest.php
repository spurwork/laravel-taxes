...
class PoseyIncomeTest extends TestCase
{
    ...
    public function testPoseyIncome(): void
    {
        ...
        $results = $this->taxes->calculate(function (Taxes $taxes) {
            ...
            $taxes->setWorkLocation($this->getLocation('us.indiana.posey'));
            $taxes->setUser($this->user);
            $taxes->setEarnings(300);
            $taxes->setPayPeriods(52);
        });

        $this->assertThat(3.75, self::identicalTo($results->getTax(PoseyIncome::class)));
    }
}
