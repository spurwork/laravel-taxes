...
class IndianaLocalIncomeTest extends TestCase
{
    ...
    {
        $results = $this->calculateTaxes(300, 1, 0);
    ...
    {
        $results = $this->calculateTaxes(300, 1, 1);
    ...
    {
        $results = $this->calculateTaxes(300, 1, 2);
    ...
    {
        $results = $this->calculateTaxes(300, 2, 1);
    ...
    {
        $results = $this->calculateTaxes(300, 0, 1);
    ...
    {
        $results = $this->calculateTaxes(300, 0, 0, true);
    ...
    {
        $results = $this->calculateTaxes(300, 0, 0, false, 10);
        $this->assertThat(19.69, self::identicalTo($results->getTax(IndianaIncome::class)));
    }

    private function calculateTaxes(
        int $earnings,
        int $personal_exemptions,
        int $dependent_exemptions,
        bool $exempt = false,
        int $additional_withholding = 0
    ): TaxResults {
