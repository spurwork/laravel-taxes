...
class WilderCityTest extends WageBaseTaxTestCase
{
    private const DATE = '2019-01-01';
    private const LOCATION = 'us.kentucky.wilder_city';
    private const TAX_CLASS = WilderCity::class;
    private const TAX_RATE = 0.0225;
