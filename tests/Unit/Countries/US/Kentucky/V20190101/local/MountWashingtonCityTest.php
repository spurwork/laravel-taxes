...
class MountWashingtonCityTest extends TaxTestCase
{
    private const DATE = '2019-01-01';
    private const LOCATION = 'us.kentucky.mount_washington_city';
    private const TAX_CLASS = MountWashingtonCity::class;
