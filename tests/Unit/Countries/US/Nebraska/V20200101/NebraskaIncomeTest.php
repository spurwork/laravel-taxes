...
namespace Appleton\Taxes\Tests\Unit\Countries\US\Nebraska\V20200101;
        ...
        return [
            ...
            '26' => [
                $builder
                    ...
                    ->setWagesInCents(70000)
                    ->setExpectedAmountInCents(3919)
                    ->build()
            ],
            '27' => [
                $builder
                    ->setTaxInfoOptions(['additional_withholding' => 100])
                    ->setWagesInCents(70000)
                    ->setExpectedAmountInCents(12919)
                    ->build()
            ],
        ];
    }
