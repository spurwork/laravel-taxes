...
namespace Appleton\Taxes\Tests\Unit\Countries\US\Hawaii\V20200101;

use Appleton\Taxes\Countries\US\Hawaii\HawaiiUnemployment\HawaiiUnemployment;
use Appleton\Taxes\Tests\Unit\Countries\UnemploymentTaxTestCase;
use Appleton\Taxes\Tests\Unit\Countries\TestParameters;

class HawaiiUnemploymentTest extends UnemploymentTaxTestCase
{
    private const DATE = '2020-01-01';
    private const LOCATION = 'us.hawaii';
    private const TAX_CLASS = HawaiiUnemployment::class;
    private const TAX_RATE = 0.024;
    private const WAGE_BASE = 4810000;
